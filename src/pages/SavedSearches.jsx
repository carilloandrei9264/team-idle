...
export default function SavedSearches() {
  ...
  async function saveSearch(event) {
    ...
    setError("");
    try { await addDoc(collection(db, "savedSearches"), { userId: user.uid, filters: { city: city.trim(), type, maxPrice: maxPrice ? Number(maxPrice) : null }, createdAt: serverTimestamp() }); setCity(""); setType(""); setMaxPrice(""); } catch { setError("This search could not be saved."); }
  }
